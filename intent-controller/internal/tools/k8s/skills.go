...
func NewLoadSkillTool(c client.Client, namespace string, allowedSkills []corev1.LocalObjectReference) (tool.Tool, error) {
	handler := func(ctx tool.Context, input LoadSkillInput) (LoadSkillOutput, error) {
		return handleLoadSkill(ctx, c, namespace, allowedSkills, input)
	}
...
func handleLoadSkill(ctx context.Context, c client.Client, namespace string, allowedSkills []corev1.LocalObjectReference, input LoadSkillInput) (LoadSkillOutput, error) {
	allowed := false
